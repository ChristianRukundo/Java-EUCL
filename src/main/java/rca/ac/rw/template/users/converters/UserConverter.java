...
//                user.getCreatedAt()
    ...
    /**
     * Converts basic User entity fields to UserProfileResponseDto.
     * Meter and Token lists will be populated by the service layer.
     */
    public static UserProfileResponseDto toUserProfileResponseDtoBasic(User user) {
        if (user == null) return null;
        ...
        // Initialize lists, to be populated by service
        dto.setMeters(Collections.emptyList());
        dto.setNewTokens(Collections.emptyList());
